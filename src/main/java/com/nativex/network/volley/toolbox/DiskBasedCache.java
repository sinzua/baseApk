...
public class DiskBasedCache implements Cache {
            ...
            if (entry2 != null) {
                ...
                try {
                    ...
                    try {
                        ...
                        Entry toCacheEntry = entry2.toCacheEntry(streamToBytes(cis2, (int) (fileLength - ((long) cis2.bytesRead))));
                        if (cis2 != null) {
                            try {
                                cis2.close();
    ...
    static void writeString(OutputStream os, String s) throws IOException {
        byte[] b = s.getBytes(DownloadManager.UTF8_CHARSET);
        writeLong(os, (long) b.length);
        os.write(b, 0, b.length);
    }

    static String readString(InputStream is) throws IOException {
        return new String(streamToBytes(is, (int) readLong(is)), DownloadManager.UTF8_CHARSET);
    }
