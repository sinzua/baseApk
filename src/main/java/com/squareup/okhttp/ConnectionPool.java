...
public final class ConnectionPool {
    ...
    public synchronized Connection get(Address address) {
        ...
        Iterator<Connection> i = this.connections.descendingIterator();
        while (i.hasNext()) {
    ...
    boolean performCleanup() {
        ...
        synchronized (this) {
            ...
            i = this.connections.descendingIterator();
            while (i.hasNext() && idleConnectionCount > this.maxIdleConnections) {
