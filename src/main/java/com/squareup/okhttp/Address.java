...
public final class Address {
    ...
    public int hashCode() {
        int hashCode;
        int i = 0;
        int hashCode2 = (((((((((((((this.uriHost.hashCode() + 527) * 31) + this.uriPort) * 31) + this.dns.hashCode()) * 31) + this.authenticator.hashCode()) * 31) + this.protocols.hashCode()) * 31) + this.connectionSpecs.hashCode()) * 31) + this.proxySelector.hashCode()) * 31;
        if (this.proxy != null) {
