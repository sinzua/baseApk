...
public class PersistentCookieStore implements CookieStore {
    ...
    public void add(URI uri, HttpCookie cookie) {
        if (!cookie.hasExpired()) {
            ...
            ((ConcurrentHashMap) this.cookies.get(cookie.getDomain())).put(cookie.getName(), cookie);
        } else if (this.cookies.containsKey(cookie.getDomain())) {
            ((ConcurrentHashMap) this.cookies.get(cookie.getDomain())).remove(cookie.getDomain());
        }
        Editor prefsWriter = this.cookiePrefs.edit();
        prefsWriter.putString(cookie.getDomain(), TextUtils.join(",", ((ConcurrentHashMap) this.cookies.get(cookie.getDomain())).keySet()));
    ...
    protected HttpCookie decodeCookie(String cookieString) {
        ...
        try {
            cookie = ((SerializableHttpCookie) new ObjectInputStream(new ByteArrayInputStream(hexStringToByteArray(cookieString))).readObject()).getCookie();
        } catch (IOException e) {
