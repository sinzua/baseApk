...
public class zzb {
    ...
    private zzb() {
        ...
        this.zzanu = new zze(1024, ((Long) zza.zzanE.get()).longValue());
        this.zzanw = new zze(1024, ((Long) zza.zzanE.get()).longValue());
    }
    ...
    private boolean zzc(Context context, Intent intent) {
        ...
        return (component == null || (zzd.zzakE && "com.google.android.gms".equals(component.getPackageName()))) ? false : zzmp.zzk(context, component.getPackageName());
    }
