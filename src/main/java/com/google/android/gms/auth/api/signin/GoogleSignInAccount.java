...
public class GoogleSignInAccount implements SafeParcelable {
    ...
    public static GoogleSignInAccount zzbH(@Nullable String str) throws JSONException {
        ...
        return zza(jSONObject.optString(CalendarEntryData.ID), jSONObject.optString("tokenId", null), jSONObject.optString("email", null), jSONObject.optString("displayName", null), parse, Long.valueOf(parseLong), jSONObject.getString("obfuscatedIdentifier"), hashSet).zzbI(jSONObject.optString("serverAuthCode", null));
    }
    ...
    private JSONObject zzmJ() {
        ...
        try {
            if (getId() != null) {
                jSONObject.put(CalendarEntryData.ID, getId());
            }
            if (getIdToken() != null) {
