...
public class zzgx implements zza<zzd> {
    ...
    public zzd zzb(zzgw com_google_android_gms_internal_zzgw, JSONObject jSONObject) throws JSONException, InterruptedException, ExecutionException {
        ...
        return new zzd(jSONObject.getString("headline"), arrayList, jSONObject.getString("body"), (zzch) zza2.get(), jSONObject.getString("call_to_action"), jSONObject.optDouble("rating", -1.0d), jSONObject.optString(ParametersKeys.STORE), jSONObject.optString(Constants.RESPONSE_PRICE), (com.google.android.gms.ads.internal.formats.zza) zzf.get(), new Bundle());
    }
}
