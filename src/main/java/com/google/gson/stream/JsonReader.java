        ...
        JsonReaderInternalAccess.INSTANCE = new JsonReaderInternalAccess() {
            public void promoteNameToValue(JsonReader reader) throws IOException {
                ...
                if (p == 13) {
                    ...
                    throw new IllegalStateException("Expected a name but was " + reader.peek() + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + " at line " + reader.getLineNumber() + " column " + reader.getColumnNumber() + " path " + reader.getPath());
                }
            }
        };
    }
