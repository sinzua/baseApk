...
public class SwipeDismissBehavior<V extends View> extends Behavior<V> {
    ...
    private final Callback mDragCallback = new Callback() {
        ...
        public void onViewPositionChanged(View child, int left, int top, int dx, int dy) {
            ...
            if (((float) left) <= startAlphaDistance) {
                ...
                ViewCompat.setAlpha(child, SwipeDismissBehavior.clamp(0.0f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT - SwipeDismissBehavior.fraction(startAlphaDistance, endAlphaDistance, (float) left), (float) DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
            }
        }
    };
    ...
    public void setDragDismissDistance(float distance) {
        this.mDragDismissThreshold = clamp(0.0f, distance, (float) DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
    }

    public void setStartAlphaSwipeDistance(float fraction) {
        this.mAlphaStartSwipeDistance = clamp(0.0f, fraction, (float) DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
    }

    public void setEndAlphaSwipeDistance(float fraction) {
        this.mAlphaEndSwipeDistance = clamp(0.0f, fraction, (float) DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
    }
