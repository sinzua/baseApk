...
public abstract class RoundedBitmapDrawable extends Drawable {
    ...
    private int mTargetDensity = ParseException.INVALID_EVENT_NAME;
    ...
    public void setTargetDensity(int density) {
        if (this.mTargetDensity != density) {
            if (density == 0) {
                density = ParseException.INVALID_EVENT_NAME;
            }
    ...
    public int getOpacity() {
        if (this.mGravity != ParseException.OPERATION_FORBIDDEN || this.mIsCircular) {
            return -3;
        }
