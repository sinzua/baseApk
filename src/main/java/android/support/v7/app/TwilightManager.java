...
class TwilightManager {
    ...
    TwilightManager(Context context) {
        ...
        this.mLocationManager = (LocationManager) context.getSystemService(CalendarEntryData.LOCATION);
    }
    ...
    private void updateState(@NonNull Location location) {
        ...
        calculator.calculateTwilight(now - ErrorReporter.MAX_REPORT_AGE, location.getLatitude(), location.getLongitude());
        ...
        calculator.calculateTwilight(ErrorReporter.MAX_REPORT_AGE + now, location.getLatitude(), location.getLongitude());
