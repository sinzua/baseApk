...
class AdapterHelper implements Callback {
    ...
    static class UpdateOp {
        ...
        public String toString() {
            return Integer.toHexString(System.identityHashCode(this)) + RequestParameters.LEFT_BRACKETS + cmdToString() + ",s:" + this.positionStart + "c:" + this.itemCount + ",p:" + this.payload + RequestParameters.RIGHT_BRACKETS;
        }
